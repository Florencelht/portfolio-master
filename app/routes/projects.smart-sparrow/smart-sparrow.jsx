import foodMenu from '~/assets/header_img.png';
...
const title = 'Food Delivery Platform';
const description =
    ...
    <>
      <ProjectContainer>
        <ProjectBackground
          ...
          src={foodMenu}
          srcSet={`${foodMenu} 1080w, ${foodMenu} 2160w`}
        ...
        <ProjectSection>
          <ProjectSectionContent>
            ...
            />
            <ProjectTextRow>
              <ProjectSectionHeading>Food Delivery Platform</ProjectSectionHeading>
              <ProjectSectionText>
        ...
        <ThemeProvider theme="dark" data-invert>
          <ProjectSection
            ...
            backgroundElement={
              <Image
                srcSet={`${foodMenu} 1280w, ${foodMenu} 2560w`}
                width={1280}
                height={900}
